...
<header>
	<div class="row">
		...
		<div class="col-sm-6 text-right h2">
	    	<a class="btn btn-primary" href="<?php echo BASEURL; ?>notas/add.php"><i class="fa fa-plus"></i> Cadastrar Nota</a>
	    	<a class="btn btn-default" href="<?php echo BASEURL; ?>notas/notas.php"><i class="fa fa-refresh"></i> Atualizar</a>
	    </div>
	</div>
</header>
...
<thead>
	<tr>
		...
		<th width="28%">MATERIA</th>
		<th width="5%">BIMESTRE</th>
		<th width="12%">NOTA</th>
...
<?php foreach ($notas as $nota) : ?>
	<tr>
		...
		<td><?php echo $nota['NotaBimestre']; ?></td>
