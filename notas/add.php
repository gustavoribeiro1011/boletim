...
<form action="<?php echo BASEURL;?>/notas/add.php" method="post">
  ...
  <div class="row">
	...
	<div class="form-group col-md-7">
      ...
      <input type="text" class="form-control" name="nota['Nota']" required>
    </div>	
	<div class="form-group col-md-7">
      <label for="name">Bimestre</label>
      <select class="form-control" name="nota['NotaBimestre']" required>
